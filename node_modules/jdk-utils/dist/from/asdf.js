...
const ASDF_DATA_DIR = (_a = process.env.ASDF_DATA_DIR) !== null && _a !== void 0 ? _a : path.join(os.homedir(), ".asdf");
const JDK_BASE_DIR = path.join(ASDF_DATA_DIR, "installs", "java");
function candidates() {
    return __awaiter(this, void 0, void 0, function* () {
        const ret = [];
        try {
            const files = yield fs.promises.readdir(JDK_BASE_DIR, { withFileTypes: true });
